...
class OpticalRadarEngine {
  ...
  OpticalRadarResult probe() {
    ...
    return const OpticalRadarResult(
      success: false,
      messageAr:
          'قياس المسافة بزمن الرحلة الضوئي يحتاج حسّاس ToF موقوتاً. '
          'هذا الهاتف لا يعطي قراءة أمتار موثوقة من وميض الفلاش وحده. '
          'يمكنك استخدام كشف العوائق كمساعدة إضافية، مع العصا البيضاء.',
    );
  }
}
